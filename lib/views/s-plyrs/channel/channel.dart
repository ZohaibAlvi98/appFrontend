                ...
                return SingleChildScrollView(
                  child: Container(
                    child: YoutubePlayerControllerProvider(
                      ...
                      child: FutureBuilder(
                          future: getlogoandbanner
                              .getSplyrLogoAndBanner(widget.splyrId),
                          builder: (BuildContext context,
                            ...
                            if (!snapshot.hasData) {
                              ...
                              return Column(
                                children: [
                                  ...
                                  Padding(
                                    padding:
                                        EdgeInsets.only(left: 15, right: 14),
                                    child: Text(
                                      item['shop']['description'],
                                      style:
                                          TextStyle(fontSize: 14, height: 1.3),
                                    ),
                                  ),
                                  SizedBox(
                                    height: 15,
                                  ...
                                  if (_pageIndex == 0)
                                    FutureBuilder(
                                        future: returndata.getSplyrsAllProducts(
                                            widget.splyrId),
                                  ...
                                  if (_pageIndex == 1)
                                    FutureBuilder(
                                        future: styledata
                                            .getVendorStyles(widget.splyrId),
                                        builder: (BuildContext context,
                                            AsyncSnapshot<
                                                    List<Map<String, dynamic>>>
                                                snapshot) {
