...
class SneakersWomens extends StatefulWidget {
  ...
  SneakersWomens({Key key, this.authenticated}) : super(key: key);
  @override
  _SneakersWomensState createState() => _SneakersWomensState();
}

class _SneakersWomensState extends State<SneakersWomens> {
  int index = 0;
                ...
                child: Container(
                  child: Column(
                    ...
                    children: [
                      ...
                      FutureBuilder(
                          future: data.getMensWomensSneakers("13"),
